...
class TestRepairRefurbish(BaseCommon):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        ...
        cls.material = cls.product_obj.create(
            {"name": "Materials", "type": "consu", "is_storable": False}
        )
    ...
    def test_01_repair_refurbish(self):
        ...
        with tests.Form(repair) as repair_form:
            repair_form.to_refurbish = True
    ...
    def test_02_repair_no_refurbish(self):
        ...
        self.assertNotEqual(move.location_dest_id, self.refurbish_loc)
