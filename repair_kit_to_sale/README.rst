...
-  When a kit product is added as a part of a repair order, its Bill of
   Materials (BoM) components are automatically exploded into separate
   stock moves. Instead of creating individual sale order lines for each
   component, this module groups them into a single sale order line for
   the original kit product when the sale order is generated.
