...
This module allows to group several repair orders, managing them more
convenient way. Such orders are synchronised in the following actions:
...
Create the first repair order. Click the "Add Another Order" button in
